...
If you want to run and test this kernel in your local computer, replace the Cross compiler in the Makefile `i386-elf-gcc` with `gcc` instead and `i386-elf-ld` with `ld` and try to install the tools you will need.
